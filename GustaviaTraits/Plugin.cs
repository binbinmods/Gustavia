...
namespace Gustavia
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Gustavia";
        public static string heroName = characterName;

        public static string subclassName = "Serenader"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Character, the Serenader.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Character",
                _contentFolder: "Gustavia",
